<template>
	<div
		ref="wrapperRef"
		class="shroudedit-date-picker relative inline-flex items-center"
		:class="[
			wrapperClass,
...
import { CalendarIcon } from '@shroudedit/assets'
import chevronLeftIcon from '@shroudedit/assets/icons/chevron-left.svg?raw'
import chevronRightIcon from '@shroudedit/assets/icons/chevron-right.svg?raw'
...
const calendarBaseClass = 'shroudedit-date-picker-calendar'
...
function ensureCalendarPortal() {
	...
	if (!calendarPortal) {
		...
		calendarPortal.classList.add('shroudedit-date-picker', 'shroudedit-date-picker-portal')
...
function syncMultiMonthSelects(instance = picker.value) {
	...
	for (const select of instance.monthNav.querySelectorAll('.shroudedit-monthDropdown-months')) {
		select.remove()
	}

	for (const monthElement of instance.monthNav.querySelectorAll('.shroudedit-hidden-cur-month')) {
		monthElement.classList.remove('shroudedit-hidden-cur-month')
	}
	...
	instance.monthElements.forEach((monthElement, index) => {
		...
		monthSelect.className = 'flatpickr-monthDropdown-months shroudedit-monthDropdown-months'
		...
		monthElement.classList.add('shroudedit-hidden-cur-month')
...
<style scoped>
.shroudedit-date-picker :deep(.flatpickr-wrapper) {
	@apply min-w-0 w-full flex-1;
}

.shroudedit-date-picker :deep(.flatpickr-calendar) {
...
.shroudedit-date-picker :deep(.flatpickr-calendar.arrowBottom) {
	margin-top: -0.5rem;
}

.shroudedit-date-picker.calendar-only {
	@apply block;
}

.shroudedit-date-picker.calendar-only :deep(.flatpickr-wrapper) {
	@apply block w-full;
}

.shroudedit-date-picker.calendar-only :deep(.flatpickr-calendar) {
	@apply m-0;
	box-sizing: content-box;
}

.shroudedit-date-picker :deep(.dayContainer) {
	@apply max-w-[307.875px] min-w-[307.875px] w-[307.875px];
}

.shroudedit-date-picker :deep(.flatpickr-calendar.multiMonth .flatpickr-rContainer),
.shroudedit-date-picker :deep(.flatpickr-calendar.multiMonth .flatpickr-days) {
	@apply max-w-none;
}
...
.shroudedit-date-picker :deep(.flatpickr-calendar.multiMonth .dayContainer + .dayContainer) {
	box-shadow: none;
}

.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars) {
	width: calc(615.75px + 0.75rem) !important;
}

.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-months),
.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-weekdays),
.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-days) {
	@apply gap-3;
}

.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-rContainer),
.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-weekdays),
.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-days) {
	width: calc(615.75px + 0.75rem) !important;
}

.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-month),
.shroudedit-date-picker :deep(.flatpickr-calendar.has-two-calendars .flatpickr-weekdaycontainer) {
	@apply max-w-[307.875px] min-w-[307.875px] flex-none;
}

.shroudedit-date-picker :deep(.flatpickr-calendar::before),
.shroudedit-date-picker :deep(.flatpickr-calendar::after) {
	display: none;
}

.shroudedit-date-picker :deep(.flatpickr-months),
.shroudedit-date-picker :deep(.flatpickr-month) {
	@apply items-center h-10 flex mb-1 overflow-visible;
}

.shroudedit-date-picker :deep(.flatpickr-month),
.shroudedit-date-picker :deep(.flatpickr-current-month),
.shroudedit-date-picker :deep(.flatpickr-weekdays),
.shroudedit-date-picker :deep(.flatpickr-weekdaycontainer) {
...
.shroudedit-date-picker :deep(.flatpickr-current-month input.cur-year),
.shroudedit-date-picker :deep(.flatpickr-current-month .flatpickr-monthDropdown-months) {
...
.shroudedit-date-picker :deep(.flatpickr-current-month .shroudedit-hidden-cur-month) {
	display: none;
}
.shroudedit-date-picker :deep(.flatpickr-current-month .flatpickr-monthDropdown-months:disabled) {
	@apply cursor-not-allowed opacity-40 hover:bg-surface-4;
}
.shroudedit-date-picker :deep(.flatpickr-current-month .numInputWrapper:has(input.cur-year)) {
	@apply w-[76px];
}
.shroudedit-date-picker :deep(.flatpickr-current-month input.cur-year) {
	@apply min-w-[76px] px-2 text-center;
}
.shroudedit-date-picker :deep(input[type='number']) {
	-moz-appearance: textfield;
	appearance: textfield;
}
.shroudedit-date-picker :deep(input[type='number']::-webkit-inner-spin-button),
.shroudedit-date-picker :deep(input[type='number']::-webkit-outer-spin-button) {
	margin: 0;
	-webkit-appearance: none;
}
.shroudedit-date-picker
	:deep(.flatpickr-current-month .numInputWrapper:has(input.cur-year:disabled)) {
	@apply cursor-not-allowed;
	background: none;
}
.shroudedit-date-picker :deep(.flatpickr-current-month input.cur-year:disabled) {
...
.shroudedit-date-picker :deep(.flatpickr-current-month input.cur-year:focus),
.shroudedit-date-picker :deep(.flatpickr-current-month .flatpickr-monthDropdown-months:focus) {
	@apply outline-none ring-4 ring-brand-shadow;
}

.shroudedit-date-picker :deep(.numInputWrapper span.arrowUp) {
	@apply border-0 rounded-tr-xl;
}
.shroudedit-date-picker :deep(.numInputWrapper span.arrowDown) {
	@apply border-0 rounded-br-xl;
}

.shroudedit-date-picker :deep(.numInputWrapper span.arrowUp::after) {
	border-bottom-color: var(--color-text-secondary);
}

.shroudedit-date-picker :deep(.numInputWrapper span.arrowDown::after) {
	border-top-color: var(--color-text-secondary);
}

.shroudedit-date-picker :deep(.flatpickr-prev-month),
.shroudedit-date-picker :deep(.flatpickr-next-month) {
...
.shroudedit-date-picker :deep(.flatpickr-prev-month.flatpickr-disabled),
.shroudedit-date-picker :deep(.flatpickr-next-month.flatpickr-disabled) {
	@apply cursor-not-allowed opacity-40 hover:bg-transparent hover:text-secondary;
}

.shroudedit-date-picker :deep(.flatpickr-prev-month svg),
.shroudedit-date-picker :deep(.flatpickr-next-month svg) {
	@apply h-5 w-5 stroke-current text-secondary;
	fill: none;
	stroke-width: 3;
}

.shroudedit-date-picker :deep(.flatpickr-prev-month:hover svg),
.shroudedit-date-picker :deep(.flatpickr-next-month:hover svg) {
	fill: none;
}

.shroudedit-date-picker :deep(.flatpickr-weekday) {
	@apply text-xs font-semibold text-secondary;
}

.shroudedit-date-picker :deep(.flatpickr-day) {
...
.shroudedit-date-picker :deep(.flatpickr-day.flatpickr-disabled) {
	@apply hover:bg-transparent;
}

.shroudedit-date-picker :deep(.flatpickr-day::before) {
	content: '';
	position: absolute;
	inset: 0 0;
	z-index: -1;
...
.shroudedit-date-picker :deep(.flatpickr-day.today) {
	@apply border-transparent;
}

.shroudedit-date-picker.show-today :deep(.flatpickr-day.today::after) {
	content: '';
	position: absolute;
	bottom: 6px;
	left: 50%;
...
.shroudedit-date-picker.show-today :deep(.flatpickr-day.today.selected::after),
.shroudedit-date-picker.show-today :deep(.flatpickr-day.today.startRange::after),
.shroudedit-date-picker.show-today :deep(.flatpickr-day.today.endRange::after) {
	@apply bg-brand-inverted;
}

.shroudedit-date-picker :deep(.flatpickr-day.selected),
.shroudedit-date-picker :deep(.flatpickr-day.startRange),
.shroudedit-date-picker :deep(.flatpickr-day.endRange) {
...
.shroudedit-date-picker :deep(.flatpickr-day.inRange) {
...
.shroudedit-date-picker :deep(.flatpickr-calendar.multiMonth .flatpickr-day.inRange) {
	box-shadow: none !important;
}

.shroudedit-date-picker :deep(.flatpickr-day.inRange::before),
.shroudedit-date-picker :deep(.flatpickr-day.startRange:not(.endRange)::before),
.shroudedit-date-picker :deep(.flatpickr-day.endRange:not(.startRange)::before) {
...
.shroudedit-date-picker :deep(.flatpickr-day.inRange:nth-child(7n + 1)::before) {
	@apply rounded-l-xl;
	left: 0;
}

.shroudedit-date-picker :deep(.flatpickr-day.inRange:nth-child(7n)::before) {
	@apply rounded-r-xl;
	right: 0;
}

.shroudedit-date-picker :deep(.flatpickr-day.startRange:not(.endRange)) {
...
.shroudedit-date-picker :deep(.flatpickr-calendar.is-missing-range-end .flatpickr-day:hover::before) {
	background: transparent;
}

.shroudedit-date-picker :deep(.flatpickr-day.startRange:nth-child(7n):not(.endRange)::before) {
	@apply rounded-r-xl;
	right: 0;
}

.shroudedit-date-picker :deep(.flatpickr-day.endRange:not(.startRange)) {
	@apply rounded-full border-brand;
}
...
.shroudedit-date-picker :deep(.flatpickr-day.endRange:nth-child(7n + 1):not(.startRange)::before) {
	@apply rounded-l-xl;
	left: 0;
}

.shroudedit-date-picker :deep(.flatpickr-calendar.multiMonth .flatpickr-day.hidden::before) {
	display: none;
}
...
.shroudedit-date-picker.can-select-range :deep(.flatpickr-day:not(.flatpickr-disabled):not(.hidden)) {
	cursor: pointer;
}

.shroudedit-date-picker.is-selecting-range
	:deep(.flatpickr-day:not(.flatpickr-disabled):not(.hidden)) {
	cursor: grabbing;
}

.shroudedit-date-picker.can-drag-range
...
.shroudedit-date-picker.is-moving-range-end
	:deep(.flatpickr-day:not(.flatpickr-disabled):not(.hidden)) {
	cursor: grabbing !important;
}

.shroudedit-date-picker.is-dragging-range :deep(.flatpickr-day) {
	cursor: grabbing !important;
}

.shroudedit-date-picker.is-dragging-range
...
.shroudedit-date-picker :deep(.flatpickr-time) {
...
.shroudedit-date-picker :deep(.flatpickr-time .numInputWrapper) {
	@apply h-full flex-1 rounded-xl bg-surface-4;
}

.shroudedit-date-picker :deep(.flatpickr-time input),
.shroudedit-date-picker :deep(.flatpickr-time .flatpickr-am-pm) {
...
.shroudedit-date-picker :deep(.flatpickr-time .flatpickr-time-separator) {
