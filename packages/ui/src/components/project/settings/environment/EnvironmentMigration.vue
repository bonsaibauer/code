...
const messages = defineMessages({
	...
	reviewOptionsDescription: {
		...
		defaultMessage:
			"We've just overhauled the Environments system on ShroudEdit and new options are now available. Please ensure the correct option is selected below and then click 'Verify' when you're done!",
	},
})
</script>
<template>
