import type { AbstractShroudEditClient, Archon } from '@shroudedit/api-client'
...
const runtimesByClient = new WeakMap<AbstractShroudEditClient, Map<string, ServerContextRuntime>>()

function getClientRuntimes(client: AbstractShroudEditClient) {
