...
const sodiumItem: ContentItem = {
	...
	project: {
		...
		title: 'Sodium',
		icon_url:
			'https://cdn.shroudedit.com/data/AANobbMI/295862f4724dc3f78df3447ad6072b2dcd3ef0c9_96.webp',
	},
	version: {
		id: '59wygFUQ',
...
const lithiumItem: ContentItem = {
	...
	project: {
		...
		title: 'Lithium',
		icon_url:
			'https://cdn.shroudedit.com/data/gvQqBUqZ/d6a1873d52b7d1c82b9a8d9b1889c9c1a29ae92d_96.webp',
	},
	version: {
		id: 'abc123',
...
const fabricApiItem: ContentItem = {
	...
	project: {
		...
		slug: 'fabric-api',
		title: 'Fabric API',
		icon_url: 'https://cdn.shroudedit.com/data/P7dR8mSH/icon.png',
	},
	version: {
		id: 'Lwa1Q6e4',
	...
	owner: {
		id: 'BZoBsPo6',
		name: 'FabricMC',
		avatar_url: 'https://cdn.shroudedit.com/data/P7dR8mSH/icon.png',
		type: 'organization',
	},
	has_update: false,
	update_version_id: null,
...
const modMenuItem: ContentItem = {
	...
	project: {
		...
		slug: 'modmenu',
		title: 'Mod Menu',
		icon_url: 'https://cdn.shroudedit.com/data/mOgUt4GM/5a20ed1450a0e1e79a1fe04e61bb4e5878bf1d20.png',
	},
	version: {
		id: 'QuU0ciaR',
...
const irisItem: ContentItem = {
	...
	project: {
		...
		slug: 'iris',
		title: 'Iris Shaders',
		icon_url: 'https://cdn.shroudedit.com/data/YL57xq9U/icon.png',
	},
	version: {
		id: 'iris123',
...
const complementaryShaderItem: ContentItem = {
	...
	project: {
		...
		icon_url: 'https://cdn.shroudedit.com/data/HVnmMxH1/icon.png',
	},
	version: {
		id: 'shaderv1',
		version_number: 'r5.3',
...
const bslShaderItem: ContentItem = {
	...
	project: {
		...
		slug: 'bsl-shaders',
		title: 'BSL Shaders',
		icon_url: 'https://cdn.shroudedit.com/data/Q1vvjJYV/icon.png',
	},
	version: {
		id: 'shaderv2',
...
const faithfulItem: ContentItem = {
	...
	project: {
		...
		slug: 'faithful-32x',
		title: 'Faithful 32x',
		icon_url: 'https://cdn.shroudedit.com/data/tAnpCviC/icon.png',
	},
	version: {
		id: 'rpv1',
		version_number: '1.21',
	...
	owner: {
		...
		avatar_url: 'https://cdn.shroudedit.com/data/tAnpCviC/icon.png',
		type: 'organization',
	},
	has_update: false,
	update_version_id: null,
		...
		template: /*html*/ `
			<div>
				...
				<ManagedContentModal
					...
					source-icon-url="https://cdn.shroudedit.com/data/5FFgwNNP/icon.png"
				/>
			</div>
		`,
	}),
		...
		template: /*html*/ `
			<div>
				...
				<ManagedContentModal
					...
					source-icon-url="https://cdn.shroudedit.com/data/1KVo5zza/icon.png"
				/>
			</div>
		`,
	}),
