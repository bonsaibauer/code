import { DownloadIcon } from '@shroudedit/assets'
	...
	render: () => ({
		...
		template: /* html */ `
			...
			<ContentDiffModal
				...
				description="An update is required to play Epic ShroudEdit Pack. Please update to the latest version to launch the game."
				:diffs="diffs"
