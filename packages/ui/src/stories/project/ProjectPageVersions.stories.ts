...
import { DownloadIcon, MoreVerticalIcon } from '@shroudedit/assets'
import type { GameVersionTag, Version } from '@shroudedit/utils'
		...
		files: [
			{
				...
				url: 'https://cdn.shroudedit.com/data/story/version-1.jar',
		...
		files: [
			{
				...
				url: 'https://cdn.shroudedit.com/data/story/version-2.jar',
			...
			},
			{
				...
				url: 'https://cdn.shroudedit.com/data/story/version-2-sources.jar',
		...
		files: [
			{
				...
				url: 'https://cdn.shroudedit.com/data/story/version-3.mrpack',
...
const meta = {
	...
	args: {
		...
		versionLink: (version: Version) => `https://shroudedit.com/mod/sodium/version/${version.id}`,
	},
	render: (args) => ({
