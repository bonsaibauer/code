...
export const Default: Story = {
	args: {
		...
		layout: 'grid',
		title: 'Example Mod',
		author: { name: 'Prospector', link: 'https://shroudedit.com/user/Prospector' },
		summary:
			'An example mod that demonstrates the ProjectCard component with a detailed description.',
		iconUrl: 'https://cdn.shroudedit.com/data/AANobbMI/icon.png',
		downloads: 1234567,
		followers: 12345,
...
export const ServerProject: Story = {
	args: {
		...
		serverModpackContent: {
			...
			icon: 'https://cdn.shroudedit.com/data/AANobbMI/icon.png',
				...
				<div>
					...
					<div class="display-mode--grid">
						<ProjectCard
							...
							:tags="['technology', 'magic']"
							:environment="{ clientSide: 'required', serverSide: 'optional' }"
							banner="https://cdn.shroudedit.com/data/AANobbMI/images/be1cc1abc9cd9c2f52bb6a39be0b4b05af24d813.png"
						/>
					</div>
				</div>
			</div>
