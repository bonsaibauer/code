...
export class ArchonNoticesV0Module extends AbstractModule {
	 ...
	 * PATCH /shroudedit/v0/notices/:id
	 */
	 ...
	 * DELETE /shroudedit/v0/notices/:id
	 */
	 ...
	 * PUT /shroudedit/v0/notices/:id/assign?server=:serverId
	 * PUT /shroudedit/v0/notices/:id/assign?node=:nodeId
	 */
	 ...
	 * PUT /shroudedit/v0/notices/:id/unassign?server=:serverId
	 * PUT /shroudedit/v0/notices/:id/unassign?node=:nodeId
	 */
