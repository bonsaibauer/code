...
export class ArchonServersV0Module extends AbstractModule {
	...
	public async get(serverId: string): Promise<Archon.Servers.v0.Server> {
		return this.client.request<Archon.Servers.v0.Server>(`/servers/${serverId}`, {
			api: 'archon',
			method: 'GET',
			version: 'shroudedit/v0',
		})
	}

	/**
	 * Get list of servers for the authenticated user
	 * GET /shroudedit/v0/servers
	 */
	public async list(
	 ...
	 * POST /shroudedit/v0/stock?region=:region
	 */
	 ...
	 * GET /shroudedit/v0/servers/:id/fs
	 */
	 ...
	 * GET /shroudedit/v0/servers/:id/ws
	 */
	 ...
	 * POST /shroudedit/v0/servers/:id/power
	 */
	public async power(
		serverId: string,
	 ...
	 * POST /shroudedit/v0/servers/:id/reinstall
	 */
	 ...
	 * GET /shroudedit/v0/servers/:id/reinstallFromMrpack
	 */
	 ...
	 * POST /shroudedit/v0/servers/:id/name
	 */
	 ...
	 * GET /shroudedit/v0/servers/:id/allocations
	 */
	 ...
	 * POST /shroudedit/v0/servers/:id/allocations?name=...
	 */
	 ...
	 * PUT /shroudedit/v0/servers/:id/allocations/:port?name=...
	 */
	 ...
	 * DELETE /shroudedit/v0/servers/:id/allocations/:port
	 */
	 ...
	 * GET /shroudedit/v0/subdomains/:subdomain/isavailable
	 */
	 ...
	 * POST /shroudedit/v0/servers/:id/subdomain
	 */
	 ...
	 * GET /shroudedit/v0/servers/:id/startup
	 */
	 ...
	 * POST /shroudedit/v0/servers/:id/startup
	 */
	 ...
	 * POST /shroudedit/v0/servers/:id/notices/:noticeId/dismiss
	 */
