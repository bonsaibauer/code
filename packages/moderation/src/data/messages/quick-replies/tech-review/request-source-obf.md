## Obfuscation on ShroudEdit

To ensure the safety of all ShroudEdit users, projects may only be uploaded with obfuscated code under specific circumstances.</br>
...
### Uploading your project to ShroudEdit without obfuscation
...
We understand that you may not want to publish the source code for this project, so you are welcome to share it privately to the [ShroudEdit Content Moderation Team](https://github.com/ShroudEditModeration) on GitHub.</br>
...
We strongly recommend that you use an automated build system to ensure that your project's outputs verifiably originate from the provided source code and are always identical to the files uploaded to ShroudEdit.</br>
