<template>
	<div class="markdown-body">
		...
		<p>
			This page was created for transparency for how the rewards program works on ShroudEdit. Feel
			free to join our Discord or email
			<a href="mailto:support@shroudedit.com">support@shroudedit.com</a> if you have any questions!
		</p>
		<p>
			This document is provided for informational purposes only and does not constitute a legal
			agreement. ShroudEdit makes no representations or warranties as to the accuracy, completeness,
		...
		<p>In this scenario, the earnings for each creator and ShroudEdit would be as follows:</p>
		<ul>
			<li>ShroudEdit: $25 (25% of $100, the site's earnings for the day)</li>
		...
		<p>
			...
			downloads are counted equally. In each category, ShroudEdit actively removes botted downloads
			and page views at our own discretion. If users are caught botting, they will be permanently
			banned from using ShroudEdit's services.
		</p>
		<p>
			You can view your page views and project downloads in your
			<a href="https://shroudedit.com/dashboard/analytics">analytics dashboard</a>.
		</p>
		...
		<p>
			No. All creators who upload to ShroudEdit automatically will receive funds as according to the
		...
		<p>
			Right now, you can use PayPal or Venmo to withdraw money from your ShroudEdit account. Gift card
			withdrawal is also available. We are working on more methods to withdraw money from your
			account. There are fees to withdraw money from your ShroudEdit account—see the revenue page in
			your dashboard for more information.
		</p>
		<h3 id="pending">What does "pending" revenue mean in my dashboard?</h3>
		<p>
			ShroudEdit receives ad revenue from our ad providers on a NET 60 day basis. Due to this, not all
		...
		<h3>How do I know ShroudEdit is being transparent about revenue?</h3>
		<p>
			We aim to be as transparent as possible with creator revenue. All of our code is open source,
			including our
		<a href="https://github.com/bonsaibauer/shroudedit/blob/main/apps/labrinth/src/queue/payouts">
				revenue distribution system</a
			>. We also have an
			<a href="https://api.shroudedit.com/v3/payout/platform_revenue">API route</a>
			to query the exact daily advertising revenue for the site - so far, creators on ShroudEdit have
		...
		<small
			>ShroudEdit's total ad revenue in the previous 5 days, for the entire dataset, use the
			aforementioned
			<a href="https://api.shroudedit.com/v3/payout/platform_revenue">API route</a>.</small
		>
	</div>
</template>

<script lang="ts" setup>
import { DatePicker, injectShroudEditClient, useFormatDateTime, useFormatMoney } from '@shroudedit/ui'
...
const description =
	'Information about the Rewards Program of ShroudEdit, an open source modding platform focused on Enshrouded.'

useSeoMeta({
	title: 'Rewards Program Information - ShroudEdit',
	description,
