...
const messages = defineMessages({
	...
	description: {
		...
		defaultMessage:
			'When you authorize an application with your ShroudEdit account, you grant it access to your account. You can manage and review access to your account here at any time.',
	},
	emptyStateHeading: {
