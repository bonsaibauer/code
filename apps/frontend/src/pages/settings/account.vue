					...
					<template v-if="twoFactorStep === 0">
						...
						<qrcode-vue
							...
							:value="`otpauth://totp/${encodeURIComponent(
								auth.user.email,
							)}?secret=${twoFactorSecret}&issuer=ShroudEdit`"
							:size="250"
							:margin="2"
							level="H"
						/>
...
const messages = defineMessages({
	...
	deleteAccountConfirmDescription: {
		...
		defaultMessage:
			'This will **immediately delete all of your user data and follows**. This will not delete your projects. Deleting your account cannot be reversed.<br><br>If you need help with your account, get support on the [ShroudEdit Discord](https://discord.shroudedit.com).',
	},
	...
	dataExportDescription: {
		...
		defaultMessage:
			'Request a copy of all your personal data you have uploaded to ShroudEdit. This may take several minutes to complete.',
	},
