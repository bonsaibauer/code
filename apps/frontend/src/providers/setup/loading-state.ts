import type { LoadingStateProvider } from '@shroudedit/ui'
import { createLoadingStateCore, provideLoadingState } from '@shroudedit/ui'
 ...
 *    `shroudedit-loading-indicator.ts`).
 */
