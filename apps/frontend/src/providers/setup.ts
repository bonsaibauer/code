import { provideNotificationManager, setupUserPreferencesProvider } from '@shroudedit/ui'
...
import { setupShroudEditClientProvider } from './setup/modrinth-client'
...
export function setupProviders(auth: Awaited<ReturnType<typeof useAuth>>) {
	...
	const client = setupShroudEditClientProvider(auth)
