...
const CMP_HIDDEN_CLASS = 'shroudedit-cmp-summary-hidden'
...
const messages = defineMessages({
	title: {
		...
		defaultMessage: 'Your privacy and how ads support ShroudEdit',
	},
	body: {
		id: 'ads-consent.body',
		defaultMessage:
			'Ads help operate ShroudEdit. Our partners may store or access cookies on the website to personalize ads and measure performance.',
	},
	manage: {
...
onMounted(() => {
	...
	installGppConsentListener()
	window.addEventListener('shroudedit-cmp-ready', installTcfConsentListener)
...
onBeforeUnmount(() => {
	...
	clearTimeout(uspCommitTimeout)
	clearTimeout(gppInstallTimeout)
	window.removeEventListener('shroudedit-cmp-ready', installTcfConsentListener)
...
<style>
html.shroudedit-cmp-summary-hidden .qc-cmp2-container,
html.shroudedit-cmp-summary-hidden #qc-cmp2-container,
html.shroudedit-cmp-summary-hidden #qc-cmp2-main,
html.shroudedit-cmp-summary-hidden #qc-cmp2-ui,
html.shroudedit-cmp-summary-hidden #qc-cmp2-usp {
