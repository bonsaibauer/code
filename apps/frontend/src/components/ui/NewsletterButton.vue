...
import { CheckIcon, MailIcon } from '@shroudedit/assets'
import { Button, defineMessages, injectShroudEditClient, useVIntl } from '@shroudedit/ui'
...
const messages = defineMessages({
	tooltipSubscribe: {
		...
		defaultMessage: 'Subscribe to the ShroudEdit newsletter',
	},
	subscribe: {
