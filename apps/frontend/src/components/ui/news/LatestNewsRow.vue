...
import { NewspaperIcon } from '@shroudedit/assets'
import { articles as rawArticles } from '@shroudedit/blog'
import { ButtonLink, defineMessages, NewsArticleCard, useVIntl } from '@shroudedit/ui'
...
const messages = defineMessages({
	latestNews: {
		...
		defaultMessage: 'Latest news from ShroudEdit',
	},
	viewAll: {
