				...
				<Row class="mb-8">
					<Column>
						<Row class="mb-4">
							<Column class="w-1/3">
								<Img
									src="https://cdn.shroudedit.com/email/bd3357dfae4b1d266250372db3a0988f.png"
									width="120"
									alt="ShroudEdit Logo"
									class="block h-auto"
								/>
							...
							<Column class="w-2/3 text-right align-top">
								<Text class="m-0 mb-2 text-2xl text-base font-bold">ShroudEdit</Text>
							</Column>
						</Row>
				...
				<Row>
					<Column class="text-center">
						<Text class="text-muted m-0 text-xs">
							This document was generated by ShroudEdit. For questions, contact
							<VLink href="mailto:support@shroudedit.com" class="text-blue"
								>support@shroudedit.com</VLink
							>
						</Text>
					</Column>
				</Row>
