...
<template>
	...
	>
		...
		<Text class="text-base">
			We want to invite you to ShroudEdit's Creator Club, a space in our discord where you can chat
			with other creators, share feedback with us, and stay plugged in.
		</Text>

		<Text class="text-base">
			To join just link your Discord account through ShroudEdit and we'll grant access automatically!
		</Text>
