...
async fn can_create_edit_get_oauth_client() {
    with_test_environment(None, |env: TestEnvironment<ApiV3>| async move {
        ...
        let redirect_uris = vec![
            "https://shroudedit.com".to_string(),
            "https://shroudedit.com/a".to_string(),
        ];
        let resp = env
            .api
            .add_oauth_client(
        ...
        let url = Some("https://shroudedit.com".to_string());
        let description = Some("test description".to_string());
        let edited_redirect_uris = vec![
            redirect_uris[0].clone(),
            "https://shroudedit.com/b".to_string(),
        ];
    ...
    with_test_environment(None, |env: TestEnvironment<ApiV3>| async move {
        let resp = env
            ...
            .add_oauth_client(
                ...
                Scopes::restricted(),
                vec!["https://shroudedit.com".to_string()],
                FRIEND_USER_PAT,
            )
            .await;
