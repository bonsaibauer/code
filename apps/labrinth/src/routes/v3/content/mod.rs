...
use shroudedit_content_management::{
...
pub async fn resolve_content(
    ...
    let plan = if cache_public_result {
        ...
        shroudedit_content_management::resolve_content(&mut provider, request)
            .await
    }
    .map_err(resolve_error_to_api)
    .wrap_api_err(
        "executing `shroudedit_content_management::resolve_content`",
    )?;
...
struct ResolveContentHeatKey<'a> {
    ...
    content_type: shroudedit_content_management::ContentType,
}
...
impl ContentMetadataProvider for &mut LabrinthContentProvider<'_> {
    async fn get_version(
        &mut self,
        version_id: &str,
    ) -> Result<Option<shroudedit_content_management::Version>, ResolveError>
    {
    ...
    async fn get_project_versions(
        &mut self,
        project_id: &str,
    ) -> Result<Vec<shroudedit_content_management::Version>, ResolveError> {
...
impl LabrinthContentProvider<'_> {
    fn record_version(
        &mut self,
        version_id: &str,
        version: Option<&shroudedit_content_management::Version>,
    ) {
        self.trace
            .versions
    ...
    fn record_project_versions(
        &mut self,
        project_id: &str,
        versions: &[shroudedit_content_management::Version],
    ) {
        self.trace
            .project_versions
...
fn hash_version(version: &shroudedit_content_management::Version) -> String {
...
fn dependency_type_cache_key(
    dependency_type: shroudedit_content_management::DependencyType,
) -> &'static str {
    match dependency_type {
        shroudedit_content_management::DependencyType::Required => "required",
        shroudedit_content_management::DependencyType::Optional => "optional",
        shroudedit_content_management::DependencyType::Incompatible => {
            "incompatible"
        }
        shroudedit_content_management::DependencyType::Embedded => "embedded",
    }
}
...
fn version_to_resolver(
    version: Version,
) -> shroudedit_content_management::Version {
    ...
    shroudedit_content_management::Version {
        ...
        dependencies: version
            .dependencies
            .into_iter()
            .map(|dependency| shroudedit_content_management::Dependency {
...
) -> shroudedit_content_management::DependencyType {
    match dependency_type {
        DependencyType::Required => {
            shroudedit_content_management::DependencyType::Required
        }
        DependencyType::Optional => {
            shroudedit_content_management::DependencyType::Optional
        }
        DependencyType::Incompatible => {
            shroudedit_content_management::DependencyType::Incompatible
        }
        DependencyType::Embedded => {
            shroudedit_content_management::DependencyType::Embedded
        }
    }
}
